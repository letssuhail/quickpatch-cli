// Regeneration entrypoint for the quickpatch_code_push_protocol package.
//
// Plugs a QuickPatch-specific [FileRenderer] into space_gen's standard
...
// `lib/quickpatch_code_push_protocol.dart`; those are hand-written and
...
class QuickPatchFileRenderer extends FileRenderer {
  ...
  @override
  String testBarrelImport() => 'quickpatch_code_push_protocol.dart';
