...
import 'package:quickpatch_code_push_client/src/version.dart';
...
/// Dart client for the QuickPatch CodePush API.
/// {@endtemplate}
class CodePushClient {
  ...
  CodePushClient({
    ...
    Map<String, String>? customHeaders,
       ...
       hostedUri = hostedUri ?? (throw ArgumentError('QUICKPATCH_HOSTED_URL is not set.'));
  ...
  /// The hosted uri for the QuickPatch CodePush API.
  final Uri hostedUri;
  ...
  /// Create a new QuickPatch user with the provided [name].
  ///
