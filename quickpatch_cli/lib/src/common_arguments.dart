...
Entries from "--dart-define" with identical keys take precedence over entries from these files.''',
  ...
  /// An argument that allows the user to specify a QuickPatch app ID directly,
  /// bypassing the app ID in quickpatch.yaml.
  static const appIdArg = ArgumentDescriber(
    name: 'app-id',
    description:
        'The QuickPatch app ID to use. Overrides the app ID in '
        'quickpatch.yaml (e.g. "your-app-id").',
  );
