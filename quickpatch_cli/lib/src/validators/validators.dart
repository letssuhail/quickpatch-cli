...
export 'quickpatch_version_validator.dart';
export 'quickpatch_yaml_asset_validator.dart';
...
/// A (potential) problem with the current QuickPatch installation or project.
@immutable
...
/// Checks for a specific issue with either the QuickPatch installation or the
