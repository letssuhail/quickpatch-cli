...
/// permission, which is required for QuickPatch to work.
///
/// See https://github.com/letssuhail/quickpatch/issues/160.
...
The command you are running must be run within a Flutter app project that supports the Android platform. If you are releasing a Flutter module, use 'aar' in place of 'android' in your quickpatch command.''';
  // coverage:ignore-end
