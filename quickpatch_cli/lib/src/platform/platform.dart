export 'package:quickpatch_cli/src/flutter_version_constraints.dart';
...
/// {@template arch}
/// Build architectures supported by QuickPatch.
///
...
enum Arch {
  ...
  /// The name used by QuickPatch to identify this architecture.
  final String arch;
}
