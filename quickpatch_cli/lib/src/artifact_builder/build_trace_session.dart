...
class BuildTraceSession {
  ...
  /// The wall-clock time at which the current `quickpatch` invocation began.
  final DateTime commandStartedAt;

  /// The Chrome Trace Event Format JSON file that producers
  /// (`flutter build --quickpatch-trace`, `aot_tools --trace`, and
  /// quickpatch_cli's own spans) append to. Null when tracing is not
