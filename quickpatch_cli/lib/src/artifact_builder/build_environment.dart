...
/// on", which is the question that decides whether QuickPatch should
...
class BuildEnvironment {
  ...
  /// is documented as "True" with a leading capital, GitHub's
  /// `GITHUB_ACTIONS` as "true"; presence sidesteps the inconsistency.
  ///
