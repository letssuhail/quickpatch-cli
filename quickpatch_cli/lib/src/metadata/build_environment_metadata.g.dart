...
BuildEnvironmentMetadata _$BuildEnvironmentMetadataFromJson(
  ...
  ($checkedConvert) {
    final val = BuildEnvironmentMetadata(
      ...
      quickpatchVersion: $checkedConvert(
        'quickpatch_version',
        (v) => v as String,
      ),
  ...
  fieldKeyMap: const {
    ...
    'quickpatchVersion': 'quickpatch_version',
    'operatingSystem': 'operating_system',
    'operatingSystemVersion': 'operating_system_version',
    'quickpatchYaml': 'quickpatch_yaml',
    'usesQuickPatchCodePushPackage': 'uses_quick_patch_code_push_package',
...
Map<String, dynamic> _$BuildEnvironmentMetadataToJson(
  ...
  'quickpatch_version': instance.quickpatchVersion,
  ...
  'uses_quick_patch_code_push_package': instance.usesQuickPatchCodePushPackage,
