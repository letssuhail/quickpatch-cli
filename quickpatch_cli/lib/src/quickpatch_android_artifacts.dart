...
/// The reference to the [QuickPatchAndroidArtifacts] instance.
final quickpatchAndroidArtifactsRef = create(QuickPatchAndroidArtifacts.new);

/// The [QuickPatchAndroidArtifacts] instance available in the current zone.
QuickPatchAndroidArtifacts get quickpatchAndroidArtifacts =>
    read(quickpatchAndroidArtifactsRef);

/// Mixin on [QuickPatchCommand] which exposes methods
// to find the artifacts generated for android
class QuickPatchAndroidArtifacts {
