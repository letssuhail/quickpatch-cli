...
import 'package:quickpatch_cli/src/executables/devicectl/nserror.dart';
import 'package:quickpatch_cli/src/executables/idevicesyslog.dart';
...
class Devicectl {
  ...
  Future<int> installAndLaunchApp({
    ...
    // in missing some quickpatch logs.
