...
/// (e.g. "doctor" for `quickpatch doctor`, "patch ios" for `quickpatch patch ios`).
///
/// Returns `null` when no subcommand was recognized (bare `quickpatch` invocation).
