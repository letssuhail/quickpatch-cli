...
abstract class Releaser {
  ...
  /// Instructions explaining next steps after running `quickpatch release`. This
  ...
  /// 'ios'). Used to construct `build/<platformSubdir>/quickpatch/`.
  ...
  // https://github.com/letssuhail/quickpatch/issues/3630
