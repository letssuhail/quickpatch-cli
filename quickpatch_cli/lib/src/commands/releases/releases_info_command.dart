...
/// `quickpatch releases info`
/// Show details for a specific release.
/// {@endtemplate}
class ReleasesInfoCommand extends QuickPatchCommand {
  ...
  String get description =>
      ...
      '    macos:    active\n'
      '    windows:  active\n\n'
      '${QuickPatchCommand.jsonHint('quickpatch releases info --release-version 1.0.0+1 --app-id <id> --json')}';
