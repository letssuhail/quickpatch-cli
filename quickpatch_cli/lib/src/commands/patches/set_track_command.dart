...
/// Sample usage:
/// ```sh
/// quickpatch patches set-track --release=1.0.0+1 --patch=1 --track=beta
/// ```
///
/// {@endtemplate}
class SetTrackCommand extends QuickPatchCommand {
  ...
  String get description =>
      ...
      '${QuickPatchCommand.jsonHint('quickpatch patches set-track --release 1.0.0+1 --patch 1 --track stable --app-id <id> --json')}';
