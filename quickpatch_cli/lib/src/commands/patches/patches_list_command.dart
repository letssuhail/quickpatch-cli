...
/// `quickpatch patches list`
/// List patches for a release.
/// {@endtemplate}
class PatchesListCommand extends QuickPatchCommand {
  ...
  String get description =>
      ...
      '${QuickPatchCommand.jsonHint('quickpatch patches list --release-version 1.0.0+1 --app-id <id> --json')}';
