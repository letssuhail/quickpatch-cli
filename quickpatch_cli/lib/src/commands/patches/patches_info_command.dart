...
import 'package:quickpatch_cli/src/formatters/file_size_formatter.dart';
...
/// `quickpatch patches info`
/// Show details for a specific patch.
/// {@endtemplate}
class PatchesInfoCommand extends QuickPatchCommand {
  ...
  String get description =>
      ...
      '    ios      arm64        896 KB\n\n'
      '${QuickPatchCommand.jsonHint('quickpatch patches info --release-version 1.0.0+1 --patch-number 1 --app-id <id> --json')}';
