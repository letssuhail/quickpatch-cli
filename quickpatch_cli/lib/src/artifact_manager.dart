...
/// Manages artifacts for the QuickPatch CLI.
class ArtifactManager {
  ...
  static Directory? androidArchsDirectory({
    ...
    //
    // See https://github.com/letssuhail/quickpatch/issues/1798
  ...
  /// Returns the quickpatch release supplement directory for the given
  ...
  Directory? getReleaseSupplementDirectory({
    ...
    final releaseSupplementDir = Directory(
      p.join(projectRoot.path, 'build', platformSubdir, 'quickpatch'),
    );
  ...
  /// Returns the path to the quickpatch release supplement directory for iOS.
  ///
  ...
  /// Returns the path to the quickpatch release supplement directory for macOS.
  ///
  /// Returns null if there is no supplement directory
  /// (e.g. when using older Flutter revisions).
  ...
  /// Name of the App.xcframework generated by `quickpatch release ios-framework`
  static const String appXcframeworkName = 'App.xcframework';

  /// Returns the path to the App.xcframework generated by
  /// `quickpatch release ios-framework` or
  /// `quickpatch patch ios-framework`.
