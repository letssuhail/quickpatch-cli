  ...
  group(ArtifactManager, () {
      ...
      group('when the directory exists', () {
        ...
        test('returns path to the directory', () {
          expect(
            ...
            equals(p.join(projectRoot.path, 'build', 'ios', 'quickpatch')),
          );
        });
      });
    });
    ...
    group('getMacosReleaseSupplementDirectory', () {
      ...
      group('when the directory exists', () {
        setUp(() {
          Directory(
            p.join(projectRoot.path, 'build', 'macos', 'quickpatch'),
          ).createSync(recursive: true);
        });
        ...
        test('returns path to the directory', () {
          expect(
            ...
            equals(p.join(projectRoot.path, 'build', 'macos', 'quickpatch')),
          );
        });
      });
    });
