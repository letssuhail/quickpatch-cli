...
void main() {
  group(Cache, () {
    const quickpatchEngineRevision = 'test-revision';
    ...
    group('clear', () {
      test('deletes the cache directory', () async {
        final quickpatchCacheDirectory = runWithOverrides(
          () => Cache.quickpatchCacheDirectory,
        )..createSync(recursive: true);
        expect(quickpatchCacheDirectory.existsSync(), isTrue);
