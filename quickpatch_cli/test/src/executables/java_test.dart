...
void main() {
  group(Java, () {
    ...
    setUp(() {
      ...
      when(quickpatchFlutter.getConfig).thenReturn({});
    });
    ...
    group('version', () {
      setUp(() {
        ...
        final processResult = MockQuickPatchProcessResult();
        when(
          () => quickpatchProcess.runSync(any(), any()),
